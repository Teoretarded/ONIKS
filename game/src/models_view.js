...
const GROUPS = [
  ['Coast', ['tel', 'transloader', 'radar', 'pantsir', 'drone', 'catapult', 'hq', 'bal', 'ssk', 'kornet', 's400', 's400r', 'bereg']],
  ['Fleet', ['destroyer', 'carrier', 'helo', 'fighter', 'aew', 'ssn', 'lhd', 'lcac', 'acv', 'cg', 'lcs']],
  ['Munitions', ['oniks', 'tlc', 'oniks_booster', 'pantsir_missile', 'sm6', 'mk72', 'mk41_can', 'strike_missile', 'essm', 'slam', 'hellfire', 'aam', 'shell', 'kh35', 'kalibr', 'torpedo533', 'vpt_can', 'kornet_msl', 's400_msl', 'rim116', 'shell130', 'shell57']],
