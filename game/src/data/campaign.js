/* Campaign: six escalating battles on the Coast side. Each opens with one of the reference films as its cutscene (the
   ...
   for each one missed (campaign/grade.js).
...
export const MISSIONS = [
  ...
  },
  {
    ...
    brief: [
      ...
      'Find them with the drones and fire before they light up.',
    ],
    objectives: [
      { id: 'find', kind: 'classify', count: 2, dom: 'sea', text: 'Find the task group', hint: 'L · launch a drone over the skerries' },
  ...
  },
  {
    ...
    brief: [
      ...
      'Keep the command post for fifteen minutes.',
    ],
    objectives: [
      { id: 'hold', kind: 'survive', seconds: 900, text: 'Hold for 15 min' },
      { id: 'cp', kind: 'protect', type: 'hq', text: 'Keep the command post' },
      { id: 'tels', kind: 'lose', type: 'tel', max: 0, optional: true, text: 'Lose no TEL' },
      { id: 'hit', kind: 'destroy', type: 'ddg', count: 1, optional: true, text: 'Sink a destroyer' },
    ],
