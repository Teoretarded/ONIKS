...
const BOX = {
  ...
  cg: [['hull', -8.4, 0, -86.4, 8.4, 9.66, 86.4], ['houseF', -7.9, 6.13, 15, 7.9, 18.3, 42], ['houseM', -5.6, 6.03, -4, 5.6, 9.3, 15], ['houseA', -7.7, 5.86, -36, 7.7, 16.2, -4], ['spy', -6.53, 11.22, -29.88, 6.33, 15.38, 41.23], ['stacks', -2.3, 9.3, -4.2, 2.3, 22.85, 14.2], ['mastF', -5.2, 18.28, 35.04, 5.2, 40.7, 38.56], ['mastM', -4.2, 16.13, -13.6, 4.2, 33, -8], ['sps', -3.65, 33, -11.1, 3.65, 37.3, -7.2], ['gunF', -2, 7.66, 60.1, 2, 10.06, 70], ['gunA', -2, 5.72, -80.5, 2, 8.12, -70.6], ['vlsF', -4.19, 7.04, 47.62, 4.17, 7.28, 54.38], ['vlsA', -4.19, 5.82, -64.38, 4.17, 6.06, -57.62], ['ciwsF', 2.88, 15.4, 20.93, 5.02, 18.76, 24.3], ['ciwsA', -5.82, 11.3, -34.7, -3.68, 14.66, -31.33], ['harpoon', -5.57, 5.69, -80.9, 5.57, 10.31, -78.1], ['arms', -7.37, 6.06, -9.73, 7.37, 7.9, -6.63], ['boats', -8.15, 9.5, -1.32, 8.15, 10.85, 9], ['hangar', -5.95, 5.91, -36.06, 5.95, 11.06, -36.04]],
  ...
  bereg: [['chassis', -1.55, 0.51, -5.85, 1.55, 1.6, 5.55], ['wheelsL', -1.54, 0, -4, -0.98, 1.5, 4.7], ['wheelsR', 0.98, 0, -4, 1.54, 1.5, 4.7], ['cabs', -1.55, 0.85, 3.95, 1.55, 2.95, 5.97], ['body', -1.5, 1.3, 0.6, 1.5, 3.35, 3.95], ['turret', -1.45, 1.55, -5.6, 1.45, 3.5, -0.7], ['gun', -0.62, 2.1, -1.8, 0.62, 3.1, 5.2], ['jacks', -1.53, 0.62, -5.53, 1.53, 1.35, 5.13]],
